...
// Code Analyzer for C, C++ and C#: http://www.viva64.com Code about getting running instances visual
// studio was borrowed from http://www.codeproject.com/KB/cs/automatingvisualstudio.aspx
...
namespace VSTool
{
    ...
    // http://msdn.microsoft.com/en-us/library/ms228772(VS.80).aspx It allows vstool to get timing
    // error messages from visualstudio and handle them.
    ...
    internal class VSToolMain
    {
        ...
        #endregion Interop imports

        private static string config = null;
        private static object dte = null;
        private static System.Boolean ignore_case = true;

        private static Hashtable projectDict = new Hashtable();
        private static object solution = null;
        private static string solution_name = null;
        private static string startup_project = null;
        private static bool use_new_vs = false;
        ...
        public static bool GetDTEAndSolution()
        {
            ...
            // Get an instance of the currently running Visual Studio .NET IDE. dte = (EnvDTE.DTE)System.Runtime.InteropServices.Marshal.GetActiveObject("VisualStudio.DTE.7.1");
        ...
        /// <summary>
        /// Get the DTE object for the instance of Visual Studio IDE that has the specified solution open.
        /// </summary>
        ...
        /// <returns>
        /// A hashtable mapping the name of the IDE in the running object table to the corresponding
        /// DTE object
        /// </returns>
            ...
            try
            {
                ...
                for (int i = 1; i <= (int)count; ++i)
                {
                    ...
                    if (0 == string.Compare(name, project_name, ignore_case))
                    {
                        ...
                        // VCProjectEngine.dll assembly, we can't cast the objects recevied from the
                        // DTE to the VCProjectEngine types from a different version than the one
                        // built with. ie, VisualStudio.DTE.7.1 objects can't be converted in a
                        // project built in VS 8.0. To avoid this problem, we can use the com object
                        // interfaces directly, without the type casting. Its tedious code, but it
                        // seems to work.
        ...
        public static bool SetStartupProject(string startup_project)
        {
            ...
            try
            {
                // You need the 'unique name of the project to set StartupProjects. find the project
                // by generic name.
        ...
        private static int Main(string[] args)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    // Walk through all of the projects in the solution and list the type of each project.
