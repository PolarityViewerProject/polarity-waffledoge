...
#ifndef OS_OSPANELQUICKSETTINGS_H
#define OS_OSPANELQUICKSETTINGS_H
...
class OSPanelQuickSettings : public LLPanel
{
public:
	OSPanelQuickSettings();
	~OSPanelQuickSettings();
...
#endif // OS_OSPANELQUICKSETTINGS_H
