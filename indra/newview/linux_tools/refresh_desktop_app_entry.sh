...
function install_desktop_entry()
{
    ...
    local desktop_entry="\
[Desktop Entry]\n\
Name=Polarity Viewer\n\
Comment=Client for the On-line Virtual World, Second Life\n\
Exec=${installation_prefix}/polarity\n\
Icon=${installation_prefix}/polarity_icon.png\n\
Terminal=false\n\
Type=Application\n\
...
X-Desktop-File-Install-Version=3.0"
    ...
    echo -e $desktop_entry > "${desktop_entries_dir}/polarity-viewer.desktop" || "Failed to install application menu!"
}
