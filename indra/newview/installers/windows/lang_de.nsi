...
LangString CloseSecondLifeInstDP ${LANG_GERMAN} "Warten auf die Beendigung von Polarity ..."
...
LangString CloseSecondLifeUnInstDP ${LANG_GERMAN} "Warten auf die Beendigung von Polarity ..."
