...
LangString CloseSecondLifeInstDP ${LANG_ITALIAN} "In attesa che Polarity chiuda…"
...
LangString CloseSecondLifeUnInstDP ${LANG_ITALIAN} "In attesa della chiusura di Polarity…"
