...
LangString CloseSecondLifeInstDP ${LANG_FRENCH} "En attente de la fermeture de Polarity..."
...
LangString CloseSecondLifeUnInstDP ${LANG_FRENCH} "En attente de la fermeture de Polarity..."
