...
LangString CloseSecondLifeInstDP ${LANG_SPANISH} "Esperando que Polarity se cierre..."
...
LangString CloseSecondLifeUnInstDP ${LANG_SPANISH} "Esperando que Polarity se cierre..."
