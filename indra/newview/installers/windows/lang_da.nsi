...
LangString CloseSecondLifeInstDP ${LANG_DANISH} "Venter på at Polarity skal lukke ned..."
...
LangString CloseSecondLifeUnInstDP ${LANG_DANISH} "Venter på at Polarity skal lukke ned..."
