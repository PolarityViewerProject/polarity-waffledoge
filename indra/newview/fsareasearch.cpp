...
BOOL FSPanelAreaSearchList::postBuild()
{
	...
	mFSAreaSearchColumnConfigConnection = gSavedSettings.getControl("PVUI_AreaSearchColumnConfig")->getSignal()->connect(boost::bind(&FSPanelAreaSearchList::updateResultListColumns, this));
