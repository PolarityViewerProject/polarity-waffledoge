...
LLViewerEventRecorder::LLViewerEventRecorder() {
  ...
  std::string old_log_ui_events_to_llsd_file = gDirUtilp->getExpandedFilename(LL_PATH_LOGS, "Obsidian_Events_log.old");
  LLFile::remove(old_log_ui_events_to_llsd_file);
  

  mLogFilename = gDirUtilp->getExpandedFilename(LL_PATH_LOGS, "Obsidian_Events_log.llsd");
