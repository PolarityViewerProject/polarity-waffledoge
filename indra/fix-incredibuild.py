...
def main():
    ...
    delete_file_types("build-vc80/newview/polarity-bin.dir/Release/", 
                      pch_types)
    delete_file_types("build-vc80/newview/RelWithDebInfo", build_types)
    delete_file_types("build-vc80/newview/polarity-bin.dir/RelWithDebInfo/", 
                      pch_types)
    delete_file_types("build-vc80/newview/Debug", build_types)
    delete_file_types("build-vc80/newview/polarity-bin.dir/Debug/", 
                      pch_types)
