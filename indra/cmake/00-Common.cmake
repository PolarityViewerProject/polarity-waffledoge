 ...
 # Clever logic to make my life easier
  ...
  if (USE_LTO)
    if(INCREMENTAL_LINK)
      ...
      set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS} /LTCG:INCREMENTAL")
      set(CMAKE_STATIC_LINKER_FLAGS_RELEASE "${CMAKE_STATIC_LINKER_FLAGS} /LTCG:INCREMENTAL")
    else(INCREMENTAL_LINK)
      set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS} ${OPT_OPTIONS} /INCREMENTAL:NO /LTCG")
      set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS} ${OPT_OPTIONS} /LTCG")
    ...
    if (INCREMENTAL_LINK)
      ...
      set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS} ${OPT_OPTIONS}")
      set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS} ${OPT_OPTIONS}")
    endif () # INCREMENTAL_LINK
  endif() # USE_LTO
