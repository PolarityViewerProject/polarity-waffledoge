...
if (WINDOWS)
 ...
 # Clever logic to make my life easier
  ...
  if (USE_LTO AND NOT INCREMENTAL_LINK) # Optimized build
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /FORCE:MULTIPLE /OPT:REF /OPT:ICF /LTCG")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /FORCE:MULTIPLE /OPT:REF /OPT:ICF /LTCG")
