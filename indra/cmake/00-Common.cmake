...
if (WINDOWS)
 ...
 # Clever logic to make my life easier
  ...
  set(CMAKE_LINKER_FLAGS_RELWITHDEBINFO "/ASSEMBLYDEBUG /OPT:NOREF /OPT:NOICF /DEBUG")
  set(CMAKE_CXX_FLAGS_RELEASE
  ...
  elseif (USE_LTO AND INCREMENTAL_LINK)
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /OPT:REF /OPT:ICF /LTCG:INCREMENTAL")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /OPT:REF /OPT:ICF /LTCG:INCREMENTAL")
    set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_STATIC_LINKER_FLAGS} /LTCG")
  elseif (NOT USE_LTO AND INCREMENTAL_LINK)
    set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS} /INCREMENTAL")
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS} /INCREMENTAL")
  else() # NOT USE_LTO AND NOT INCREMENTAL_LINK
