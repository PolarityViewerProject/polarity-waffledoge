...
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO 
    "-DLL_RELEASE=1 -DNDEBUG=1 -DLL_RELEASE_WITH_DEBUG_INFO=1 -DLL_RELEASE_FOR_DOWNLOAD=0")
...
if (WINDOWS)
 ...
 # Clever logic to make my life easier
  ...
  set(CMAKE_CXX_FLAGS_RELEASE
      "${CMAKE_CXX_FLAGS_RELEASE} /O2 /Oi /Ot /Zi /Zo /MD ${CXX_JOBS} /Ob2 /Qpar /Qimprecise_fwaits /Qfast_transcendentals /Zc:inline -D_ITERATOR_DEBUG_LEVEL=0"
  ...
  if (LL_RELEASE_FOR_DOWNLOAD)
    set(PDB_TYPE "/DEBUG:FULL")
   else()
    set(PDB_TYPE "/DEBUG:FASTLINK")
  endif (LL_RELEASE_FOR_DOWNLOAD)

  set (CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS_RELEASE} /NODEFAULTLIB:LIBCMT ${PDB_TYPE}")
  set (CMAKE_SHARED_LINKER_FLAGS_DEBUG "${CMAKE_SHARED_LINKER_FLAGS_DEBUG} /NODEFAULTLIB:LIBCMT /NODEFAULTLIB:LIBCMTD /NODEFAULTLIB:MSVCRT ${PDB_TYPE}")
  set (CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} /NODEFAULTLIB:LIBCMT ${PDB_TYPE}")
  set (CMAKE_EXE_LINKER_FLAGS_DEBUG "${CMAKE_EXE_LINKER_FLAGS_DEBUG} /NODEFAULTLIB:LIBCMT /NODEFAULTLIB:LIBCMTD /NODEFAULTLIB:MSVCRT ${PDB_TYPE}")
  
  if (USE_LTO)
    if(INCREMENTAL_LINK)
      set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /OPT:NOREF /OPT:NOICF /LTCG:INCREMENTAL")
      set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /OPT:NOREF /OPT:NOICF /LTCG:INCREMENTAL")
      set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_STATIC_LINKER_FLAGS} /OPT:NOREF /OPT:NOICF /LTCG:INCREMENTAL")
    else()
      ...
      set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_STATIC_LINKER_FLAGS} /INCREMENTAL:NO /OPT:REF /OPT:ICF /LTCG")
    endif(INCREMENTAL_LINK)
  elseif(NOT_LTO)
  if (INCREMENTAL_LINK)
    set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS} /OPT:NOREF /OPT:NOICF /INCREMENTAL /VERBOSE:INCR")
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS} /OPT:NOREF /OPT:NOICF /INCREMENTAL /VERBOSE:INCR")
  else (NOT INCREMENTAL_LINK)
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /INCREMENTAL:NO /OPT:REF /OPT:ICF")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /INCREMENTAL:NO /OPT:REF /OPT:ICF")
  endif(INCREMENTAL_LINK)
  endif (USE_LTO)
