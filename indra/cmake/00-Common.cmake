...
if (WINDOWS)
 ...
 # Clever logic to make my life easier
  ...
  set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /Od /Zi /MDd ${CXX_JOBS} /RTC1 -D_SCL_SECURE_NO_WARNINGS=1"
      CACHE STRING "C++ compiler debug options" FORCE)
  set(CMAKE_CXX_FLAGS_RELWITHDEBINFO 
      "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} /Od /Z7 /MD ${CXX_JOBS} /Ob0 /Zc:inline- /RTC1 -D_ITERATOR_DEBUG_LEVEL=0"
  ...
  elseif (INCREMENTAL_LINK)
    ...
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /OPT:REF /INCREMENTAL:NO /debug:full")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /OPT:REF /INCREMENTAL:NO /debug:full")
  endif ()
