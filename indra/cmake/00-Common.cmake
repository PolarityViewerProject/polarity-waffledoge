...
if (WINDOWS)
 ...
 # Clever logic to make my life easier
  ...
  set(CMAKE_LINKER_FLAGS_RELWITHDEBINFO "/ASSEMBLYDEBUG /OPT:NOREF /OPT:NOICF /INCREMENTAL /DEBUG")
  set(CMAKE_CXX_FLAGS_RELEASE
  ...
  if (USE_LTO AND NOT INCREMENTAL_LINK)
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /INCREMENTAL:NO /OPT:REF /OPT:ICF /LTCG /FORCE:MULTIPLE")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /INCREMENTAL:NO /OPT:REF /OPT:ICF /LTCG /FORCE:MULTIPLE")
    set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_STATIC_LINKER_FLAGS} /INCREMENTAL:NO /LTCG /FORCE:MULTIPLE")
  elseif (INCREMENTAL_LINK AND NOT USE_LTO)
    set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS} /INCREMENTAL /VERBOSE:INCR /FORCE:MULTIPLE")
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS} /INCREMENTAL /VERBOSE:INCR /FORCE:MULTIPLE")
  else ()
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /OPT:REF /INCREMENTAL:NO /FORCE:MULTIPLE")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /OPT:REF /INCREMENTAL:NO /FORCE:MULTIPLE")
