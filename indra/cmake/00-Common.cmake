...
if (WINDOWS)
 ...
 # Clever logic to make my life easier
  ...
  if (USE_LTO AND NOT INCREMENTAL_LINK) # Optimized build
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS}       /OPT:REF /OPT:ICF=8 /LTCG")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /OPT:REF /OPT:ICF=8 /LTCG")
    ...
    set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS} /DEBUG /LTCG:OFF /OPT:REF /OPT:ICF=8 /INCREMENTAL:NO")
    set(CMAKE_EXE_LINKER_FLAGS_RELEASE    "${CMAKE_EXE_LINKER_FLAGS}    /DEBUG /LTCG:OFF /OPT:REF /OPT:ICF=8 /INCREMENTAL:NO")
