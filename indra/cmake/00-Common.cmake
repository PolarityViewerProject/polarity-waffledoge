...
if (WINDOWS)
 ...
 # Clever logic to make my life easier
  ...
  #set(CMAKE_STATIC_LINKER_FLAGS_RELEASE "${CMAKE_STATIC_LINKER_FLAGS_RELEASE} /FORCE:MULTIPLE") # Static linker does not recognize FORCE:MULTIPLE
  ...
  if (USE_LTO AND NOT INCREMENTAL_LINK) # Optimized build
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /FORCE:MULTIPLE /OPT:REF /OPT:ICF /LTCG /LTCG:STATUS")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /FORCE:MULTIPLE /OPT:REF /OPT:ICF /LTCG /LTCG:STATUS")
    set(CMAKE_STATIC_LINKER_FLAGS "${CMAKE_STATIC_LINKER_FLAGS} /LTCG")
  else (NOT LTO AND INCREMENTAL_LINK) # Dev build, default.
	set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS} /FORCE:MULTIPLE /DEBUG /INCREMENTAL /OPT:NOICF")
	set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS} /FORCE:MULTIPLE /DEBUG /INCREMENTAL /OPT:NOICF")
  else()
  # Not sure when this would be hit, we only make fully optimized or dev builds (or treat unoptimized builds as such)
   MESSAGE("Warning: Non-standard configuration, expect odd results")
