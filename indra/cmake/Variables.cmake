...
if (OpenMP_Support)
  add_definitions(/DOpenMP_Support=ON)
  MESSAGE("Multi-threading:                   OpenMP")
  MESSAGE("With:")
  if(OpenMP_ImageWorker)
    add_definitions(/DOpenMP_ImageWorker=ON)
    MESSAGE("OpenMP Image worker")
  endif()
  if(OpenMP_ManualThreads)
    add_definitions(/DOpenMP_ManualThreads=ON)
    MESSAGE("OpenMP Manual Threading")
  endif()
else()
  if(WINDOWS)
    MESSAGE("Multi-threading:                   Auto-Parallelizer")
  endif()
endif()
if(RELEASE_BUILD)
